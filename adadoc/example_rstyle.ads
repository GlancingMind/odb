--
-- $Id: example_rstyle.ads,v 1.1.1.1 2003/06/23 07:37:12 merdmann Exp $
--
...
package Example is
   ...
   generic
     ............
   procedure Z( U : in String ) ;
   --
   -- This is a generic which does not compile
   --

   generic
     ............
   procedure U( U : in String ) ;
   --
   -- This is a generic which does not compile
   --
end Example;
